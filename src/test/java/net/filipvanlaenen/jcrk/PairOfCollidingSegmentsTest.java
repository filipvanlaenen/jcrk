...
public class PairOfCollidingSegmentsTest {
	private static final TruncatedStandardHashFunction TRUNCATED_SHA1_5_BITS = new TruncatedStandardHashFunction(
			StandardHashFunction.SHA1, 5);
	private static final TruncatedStandardHashFunction TRUNCATED_SHA1_8_BITS = new TruncatedStandardHashFunction(
			StandardHashFunction.SHA1, 8);
	private static final TruncatedStandardHashFunction TRUNCATED_SHA256_8_BITS = new TruncatedStandardHashFunction(
	...
	/**
	 * The CollisionFinder finds the collision for a pair of colliding segments
	 * for which it has to iterate in the loop.
	 */
	@Test
